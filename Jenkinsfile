...
if(mavenSuccess) {
  ...
  node {
    ...
    //build 'Publish Beta apk'
  }

  currentBuild.result = 'SUCCESS'
} else {
  // Notify on Slack
  //slackSend channel: '#android-testing', color: 'danger', message: 'Appium tests failed. Waiting for QA/QC decision to override.', teamDomain: 'metropia', token: 'W0j3RLOzMbJAW84nqmPiHyvQ'
